...
Because of renaming issues, you should still install Captusi with the old package name, mp3-downloader. I will fix this in the future, but for now the package name remains the same. The command name is already changed to captusi. For more info about the installation instructions, check the [wiki](http://example.com).
